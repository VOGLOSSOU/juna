export const ERROR_CODES = {
  ...
  SUBSCRIPTION_PROPOSAL_NOT_FOUND: 'SUBSCRIPTION_PROPOSAL_NOT_FOUND',
  SUBSCRIPTION_PROPOSAL_ALREADY_PROCESSED: 'SUBSCRIPTION_PROPOSAL_ALREADY_PROCESSED',
  MEAL_IN_PENDING_PROPOSAL: 'MEAL_IN_PENDING_PROPOSAL',
...
export const ERROR_MESSAGES = {
  ...
  [ERROR_CODES.SUBSCRIPTION_PROPOSAL_NOT_FOUND]: 'Proposition d\'abonnement introuvable',
  [ERROR_CODES.SUBSCRIPTION_PROPOSAL_ALREADY_PROCESSED]: 'Cette proposition a déjà été traitée',
  [ERROR_CODES.MEAL_IN_PENDING_PROPOSAL]: 'Ce repas est référencé dans une proposition d\'abonnement en attente',
  ...
  [ERROR_CODES.ORDER_NOT_COMPLETED]: 'La commande doit être livrée pour donner un avis',
  ...
  [ERROR_CODES.INVALID_OPERATION]: 'Opération invalide',
